defmodule PinchflatWeb.Discovery.DiscoveryLive do
  ...
  def handle_event("accept", %{"id" => id}, socket) do
    ...
    {:noreply,
     ...
     |> redirect(to: ~p"/sources/new?prefill_url=#{suggestion.url}")}
  end
  ...
  defp load_suggestions(socket) do
    suggestions = Discovery.list_suggestions("pending")
    settings = Discovery.discovery_settings()
    assign(socket, suggestions: suggestions, discovery_enabled: settings.enabled)
  end
